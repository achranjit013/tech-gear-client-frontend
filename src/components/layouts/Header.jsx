              ...
              <div className="space-y-2 py-6 sm:py-3">
                <div className="relative block sm:hidden">
                  ...
                  <input
                    type="text"
                    id="search-navbar"
                    className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 placeholder-gray-400"
                    placeholder="Search..."
                  />
                </div>
              </div>
